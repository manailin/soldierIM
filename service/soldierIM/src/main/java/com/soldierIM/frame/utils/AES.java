package com.wowtour.frame.utils;
...
public class AES
{
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		String cKey = "1438246685880100";
		// 需要加密的字串
		String cSrc = "10+5c18216aeb19c1a79f821902d846067b";
		System.out.println(cSrc);
		// 加密
		long lStart = System.currentTimeMillis();
		String enString = AES.encrypt(cSrc, cKey, "UTF-8");
...
//		System.out.println("加密耗时：" + lUseTime + "毫秒");
		...
		String DeString = AES.decrypt("JZD2jQ2UZ1FGNlbR8Ui6muILqvySXd1jFbu2RfCBjpUAq76UysU9ChzTJ3+UV/9t", cKey, "UTF-8");
		System.out.println("解密后的字串是：" + DeString);
		lUseTime = System.currentTimeMillis() - lStart;
		System.out.println("解密耗时：" + lUseTime + "毫秒");
		
//		String cKey = "UMALLSUB82133256";
//		String input = "12345678901234561111";
//		String output = AES.decrypt(input, cKey, "UTF-8");
